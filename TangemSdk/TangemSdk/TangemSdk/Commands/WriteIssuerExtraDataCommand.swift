...
public final class WriteIssuerExtraDataCommand: PreflightCommand {
    ...
    public func run(session: CommandTransiever, viewDelegate: CardManagerDelegate, environment: CardEnvironment, currentCard: Card, completion: @escaping (Result<WriteIssuerExtraDataResponse, TaskError>) -> Void) {
