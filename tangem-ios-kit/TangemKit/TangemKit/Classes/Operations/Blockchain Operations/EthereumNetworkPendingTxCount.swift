...
class EthereumNetworkPendingTxCountOperation: GBAsyncOperation {
    ...
    init(address: String, completion: @escaping (TangemObjectResult<Int>) -> Void) {
        self.address = address
        self.completion = completion
    }
    
    override func main() {
        let jsonDict = ["jsonrpc": "2.0", "method": "eth_getTransactionCount", "params": [address, "pending"], "id": 67] as [String: Any]
