...
target 'Tangem Tap' do
  ...
  pod 'TangemSdk', :git => 'git@bitbucket.org:tangem/card-sdk-swift.git', :tag => 'build-64'
  #pod 'TangemSdk', :path => '../card-sdk-swift'
  pod 'BlockchainSdk',:git => 'git@bitbucket.org:tangem/blockchain-sdk-swift.git', :tag => 'build-33'
