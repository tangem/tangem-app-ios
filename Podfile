...
target 'Tangem Tap' do
  ...
  pod 'TangemSdk', :git => 'git@bitbucket.org:tangem/card-sdk-swift.git', :tag => 'build-80'
  #pod 'TangemSdk', :path => '../card-sdk-swift'
  pod 'BlockchainSdk',:git => 'git@bitbucket.org:tangem/blockchain-sdk-swift.git', :tag => 'build-52'
  #pod 'BlockchainSdk', :path => '../blockchain-sdk-swift'
  pod 'web3swift', :git => 'https://bitbucket.org/tangem/web3swift.git', :tag => '2.2.4'
  #pod 'web3swift', :path => '../web3swift'
  #pod 'BitcoinCore.swift', :path => '../bitcoincore'
  pod 'BitcoinCore.swift', :git => 'https://bitbucket.org/tangem/bitcoincore.git', :tag => '0.0.4'
  pod 'Moya'
  pod 'EFQRCode'
