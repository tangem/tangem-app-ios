...
import WalletCore
 ...
 struct UTXOScriptTypeBuilder {
    func from(address: String) -> UTXOScriptType {
        let lockScript = WalletCore.BitcoinScript.lockScriptForAddress(address: address, coin: .bitcoinCash)


    }
 }

enum UTXOScriptType: String, Hashable {
    case p2pk
    case p2pkh
    case p2sh
    case p2wsh
    ...
    var inputSize: Int {
        ...
        case .p2wpkh:
            ...
            return 69
        case .p2wpkhSh:
            // P2SH wrapped segwit: redeem script + witness data ≈ 91 bytes
            return 91
        }
    }
    ...
    var outputSize: Int {
        ...
        case .p2wpkh:
            ...
            return 22
        case .p2wpkhSh:
            // Standard P2SH output size: OP_HASH160 + push(20) + scriptHash(20) + OP_EQUAL = 23 bytes
            return 23
        }
    }
}
