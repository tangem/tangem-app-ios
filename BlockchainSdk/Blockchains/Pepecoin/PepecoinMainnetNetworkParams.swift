...
final class PepecoinMainnetNetworkParams: INetwork {
    /// base58Prefixes[PUBKEY_ADDRESS]
    let pubKeyHash: UInt8 = 0x38

    /// base58Prefixes[SECRET_KEY]
    let privateKey: UInt8 = 0x9E

    /// base58Prefixes[SCRIPT_ADDRESS]
    let scriptHash: UInt8 = 0x16

    /// bech32_hrp
    let bech32PrefixPattern: String = "P"

    /// base58Prefixes[EXT_PUBLIC_KEY]
    let xPubKey: UInt32 = 0x02FACAFD

    /// base58Prefixes[EXT_SECRET_KEY]
    let xPrivKey: UInt32 = 0x02FAC398

    let magic: UInt32 = 0xC0C0C0C0

    /// nDefaultPort
    let port: UInt32 = 33874
...
extension PepecoinMainnetNetworkParams: UTXONetworkParams {
