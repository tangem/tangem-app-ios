...
struct RadiantScriptUtils {
    ...
    func writePrevoutHash(_ unspents: [SignedUnspentOutput], into txToSign: inout Data) {
    ...
    func writeSequenceHash(_ unspents: [SignedUnspentOutput], into txToSign: inout Data) {
