...
extension SendFeeSelectorScreen {
    ...
    @discardableResult
    func assertCoinOffersSpeedChoice() -> Self {
        XCTContext.runActivity(named: "Assert the coin fee offers a speed choice (Market and Fast)") { _ in
            ...
            waitAndAssertTrue(chooseSpeedTitle, "'Choose speed' sheet should open for a coin fee")
            waitAndAssertTrue(marketOption, "Market speed should be available for a coin fee")
            waitAndAssertTrue(fastOption, "Fast speed should be available for a coin fee")
