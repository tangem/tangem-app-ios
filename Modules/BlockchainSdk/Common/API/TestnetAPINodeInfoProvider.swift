    ...
    func urls() -> [NodeInfo]? {
        ...
        case .hedera:
            return [
                ...
                .init(
                    url: URL(string: "https://starter.arkhia.io/hedera/testnet/api/v1")!,
        ...
        case .ethereum:
            return [
                .init(url: URL(string: "https://ethereum-sepolia.gateway.tatum.io")!),
        ...
        case .igra:
            return [
                .init(url: URL(string: "https://galleon-testnet.igralabs.com:8545")!),
            ]
        case .robinhood:
        ...
        case .arc:
            return [
                .init(url: URL(string: "https://rpc.testnet.arc.io")!),
            ]
        case .seiEvm:
            return [
