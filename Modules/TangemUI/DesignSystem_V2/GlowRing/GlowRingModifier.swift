...
public extension View {
    /// - Parameter isAnimating: pass the condition that drives visibility (e.g. the inverse of an
    ///   `.opacity(0)` hide) so the animation stops while invisible. Navigation/tab/lazy-scroll
    ///   hiding is handled automatically and needs no flag.
    func glowRing(
