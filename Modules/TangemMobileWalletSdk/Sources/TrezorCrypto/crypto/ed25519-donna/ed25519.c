...
void
ED25519_FN(tangem_vendored_ed25519_sign) (const unsigned char *m, size_t mlen, const ed25519_secret_key sk, ed25519_signature RS) {
	hash_512bits extsk = {0};
	ed25519_extsk(extsk, sk);
...
ED25519_FN(ed25519_sign_open) (const unsigned char *m, size_t mlen, const ed25519_public_key pk, const ed25519_signature RS) {
	...
	return tangem_vendored_ed25519_verify(RS, checkR, 32) ? 0 : -1;
}
