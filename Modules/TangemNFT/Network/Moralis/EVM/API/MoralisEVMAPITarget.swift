...
extension MoralisEVMAPITarget {
    enum Target {
        /// https://docs.moralis.com/web3-data-api/evm/reference/get-wallet-nft-collections
        case getNFTCollectionsByWallet(address: String, params: MoralisEVMNetworkParams.NFTCollectionsByWallet)

        /// https://docs.moralis.com/web3-data-api/evm/reference/get-wallet-nfts
        case getNFTAssetsByWallet(address: String, params: MoralisEVMNetworkParams.NFTAssetsByWallet)

        /// https://docs.moralis.com/web3-data-api/evm/reference/get-multiple-nfts
        case getNFTAssets(queryParams: MoralisEVMNetworkParams.NFTAssetsQuery?, bodyParams: MoralisEVMNetworkParams.NFTAssetsBody)

        /// https://docs.moralis.com/web3-data-api/evm/reference/get-nft-sale-prices
        case getNFTSalePrice(collectionAddress: String, tokenId: String, params: MoralisEVMNetworkParams.NFTSalePrice)
    }
...
extension MoralisEVMAPITarget: TargetType {
    var baseURL: URL {
