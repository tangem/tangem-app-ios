...
public enum Localization {
  ...
  /// Please try again later. If it keeps happening, get in touch with support and we’ll help you resolve it.
  ...
  /// Get Tangem Visa
  public static let detailsGetVisa = Localization.tr("Localizable", "details_get_visa")
  /// Access code
  ...
  /// Manually save your recovery phrase in a secure place and keep it private to protect your funds.
  ...
  /// You must update to %1$@ in order to create mobile wallet
  ...
  /// We’re getting your card ready. This may take a little time.
