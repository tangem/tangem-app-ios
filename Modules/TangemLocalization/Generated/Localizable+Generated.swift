...
public enum Localization {
  ...
  /// This account participates in the referral program.
  ...
  /// Can’t recover account
  public static let accountRecoverLimitDialogTitle = Localization.tr("Localizable", "account_recover_limit_dialog_title")
  /// Account recovered
  ...
  /// Some custom tokens were moved from “%1$s” to “%2$s” as their derivation belongs to that account.
  public static func accountsMigrationAlertMessage(_ p1: UnsafePointer<CChar>, _ p2: UnsafePointer<CChar>) -> String {
    return Localization.tr("Localizable", "accounts_migration_alert_message", p1, p2)
  }
  /// Some custom tokens were moved
  ...
  /// Token added to %1$s account
  public static func customTokenAnotherAccountSnackbarText(_ p1: UnsafePointer<CChar>) -> String {
    return Localization.tr("Localizable", "custom_token_another_account_snackbar_text", p1)
  }
  /// Contract address
  ...
  /// Your backup is created using 2 or 3 Tangem cards. Keep them in separate safe places to protect against loss or damage — no seed phrase needed.
  ...
  /// Your private key is generated directly inside the Tangem card and never leaves it.
  ...
  /// Move your current wallet into Tangem Wallet.
  ...
  /// To upgrade your wallet to hardware, back it up first.
  ...
  /// No seed phrase is needed anymore — your Tangem card or ring becomes your secure backup.
  ...
  /// APR %1$s%%
  public static func stakingAprEarnBadge(_ p1: UnsafePointer<CChar>) -> String {
    return Localization.tr("Localizable", "staking_apr_earn_badge", p1)
  }
  /// Claim unstaked
  ...
  /// Keep your money safe if your card is lost or stolen. You can unfreeze anytime.
  ...
  /// Open
  public static let tangempayCardDetailsOpenWalletStep1AppleOpen = Localization.tr("Localizable", "tangempay_card_details_open_wallet_step_1_apple_open")
  /// Apple Wallet
  public static let tangempayCardDetailsOpenWalletStep1AppleWallet = Localization.tr("Localizable", "tangempay_card_details_open_wallet_step_1_apple_wallet")
  /// Tap “Add a card”
  ...
  /// Supplying %1$@ %2$@ to Aave is pending
  ...
  /// Every top-up will be supplied to Aave automatically.
  ...
  public enum TangempayCardDetailsOpenWalletStep1 {
    /// Tap “+” button on the top right
    public static let _5Apple = Localization.tr("Localizable", "tangempay_card_details_open_wallet_step_1.5_apple")
  }
}
