...
public enum Localization {
  ...
  /// Dynamic addresses create a new one each time for extra privacy — your total balance stays the same. 
  ...
  /// Grant permission
  public static let pushNotificationSettingsBannerButtonGrantPermission = Localization.tr("Localizable", "push_notification_settings_banner_button_grant_permission")
  ...
  public static let pushNotificationSettingsBannerDescriptionGrantPermission = Localization.tr("Localizable", "push_notification_settings_banner_description_grant_permission")
  /// Allow notifications
  ...
  /// This was done due to regulatory requirements. Anyway withdrawals are still available.
