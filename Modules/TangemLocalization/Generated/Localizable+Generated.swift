...
public enum Localization {
  /// Your wallet won’t be protected without an Access Code.
  ...
  /// Wrong access code. Your hot wallet will be deleted after %@ more incorrect attempts.
  ...
  /// Wrong access code. App will be locked with %@ more input errors
  ...
  /// Confirm your previously entered code to continue
  ...
  /// You’re about to recover “%1$@”.
  public static func accountArchivedRecoverDialogDescription(_ p1: Any) -> String {
    return Localization.tr("Localizable", "account_archived_recover_dialog_description", String(describing: p1))
  }
  /// Recover account
  public static let accountArchivedRecoverDialogTitle = Localization.tr("Localizable", "account_archived_recover_dialog_title")
  /// Archived
  ...
  /// Archive
  public static let accountDetailsArchiveAction = Localization.tr("Localizable", "account_details_archive_action")
  ...
  /// Use %1$@ to quickly and securely unlock your wallet and authorize all sensitive actions, such as signing transactions. For hardware wallets, you will still need a card to sign.
  ...
  public static func appSettingsOffBiometricsAlertMessage(_ p1: UnsafePointer<CChar>) -> String {
    return Localization.tr("Localizable", "app_settings_off_biometrics_alert_message", p1)
  }
  ...
  /// Your Secret Recovery Phrase is a fixed set of %@ random words used to access and recover your wallet.
  ...
  /// Save these %@ words in a secure location, such as a password manager, and never share them with anyone.
  ...
  /// Never share these words. Anyone who learns them can steal all of your crypto. Tangem will never ask you for them. The %@ words below are your wallet's recovery phrase. This phrase lets you recover your wallet if you lose your device.
  ...
  /// Write down these %@ words in order and keep them safe and private
  ...
  /// Full responsibility for the security and backup of the wallet and recovery phrase lies with the user, not with Tangem.
  ...
  public static let customTokenCreationErrorInvalidDerivationPath = Localization.tr("Localizable", "custom_token_creation_error_invalid_derivation_path")
  ...
  /// BIP44 coin type
  public static let customTokenDerivationPathInputTitle = Localization.tr("Localizable", "custom_token_derivation_path_input_title")
  /// The derivation path you've entered is not valid
  public static let customTokenInvalidDerivationPath = Localization.tr("Localizable", "custom_token_invalid_derivation_path")
  /// E.g. USD Coin
  ...
  /// Not selected
  public static let customTokenNetworkInputNotSelected = Localization.tr("Localizable", "custom_token_network_input_not_selected")
  /// Network
  ...
  /// Token symbol
  public static let customTokenTokenSymbolInputTitleOld = Localization.tr("Localizable", "custom_token_token_symbol_input_title_old")
  ...
  /// Contact support
  public static let detailsRowTitleContactToSupport = Localization.tr("Localizable", "details_row_title_contact_to_support")
  /// Open support chat
  ...
  /// You can synchronize up to three cards or rings into one wallet. It can only be done once.
  ...
  /// Legacy Address
  public static let domainReceiveAssetsLegacyAddress = Localization.tr("Localizable", "domain_receive_assets_legacy_address")
  /// Receive assets
  ...
  /// Specify the approve limit for the selected token
  ...
  /// Are you sure you want to exit the access code creation process?
  ...
  /// Upgrade your security right away with a best in class hardware wallet from Tangem.
  ...
  /// Recover an existing wallet stored in your iCloud backup
  ...
  /// To secure your wallet with a Access Code, complete the backup first.
  ...
  /// Physical cards that securely store your crypto offline.
  ...
  /// Private keys will be moved from the app to your Tangem card or ring
  ...
  /// You’re about to upgrade your wallet to Tangem Wallet. This will keep your assets safe with cold storage.
  ...
  /// Blockchain the cryptocurrency was initially created
  public static let manageTokensNetworkSelectorNativeSubtitle = Localization.tr("Localizable", "manage_tokens_network_selector_native_subtitle")
  /// Native network
  public static let manageTokensNetworkSelectorNativeTitle = Localization.tr("Localizable", "manage_tokens_network_selector_native_title")
  /// Using non-native networks for tokens enables cross-blockchain interoperability, allowing assets to be utilized in diverse decentralized applications and smart contracts across platforms. However, this often involves a custodian or smart contract to hold the original asset securely, introducing centralization and counterparty risk.
  public static let manageTokensNetworkSelectorNonNativeInfo = Localization.tr("Localizable", "manage_tokens_network_selector_non_native_info")
  /// Not original or primary blockchain the token is hosted
  public static let manageTokensNetworkSelectorNonNativeSubtitle = Localization.tr("Localizable", "manage_tokens_network_selector_non_native_subtitle")
  /// Non-native networks
  public static let manageTokensNetworkSelectorNonNativeTitle = Localization.tr("Localizable", "manage_tokens_network_selector_non_native_title")
  /// Choose networks
  public static let manageTokensNetworkSelectorTitle = Localization.tr("Localizable", "manage_tokens_network_selector_title")
  /// Wallet
  public static let manageTokensNetworkSelectorWallet = Localization.tr("Localizable", "manage_tokens_network_selector_wallet")
  ...
  /// %1$li NFTs in %2$li collections
  public static func nftWalletCount(_ p1: Int, _ p2: Int) -> String {
    return Localization.tr("Localizable", "nft_wallet_count", p1, p2)
  }
  ...
  public static let notificationReferralPromoText = Localization.tr("Localizable", "notification_referral_promo_text")
  /// Get REWARDS for every friend!
  public static let notificationReferralPromoTitle = Localization.tr("Localizable", "notification_referral_promo_title")
  /// Buy crypto
  ...
  /// You've added one backup card or ring. When backup process is finished you can't add more backup devices. If you have one more card or ring, add it to the backup. Would you like to continue the backup process?
  ...
  /// The passphrase is an advanced security feature that crypto wallets use. It adds an extra word or phrase of your own choosing to your already existing recovery phrase to unlock a brand-new set of addresses.
  ...
  /// Scan card #%li
  public static func onboardingButtonBackupCardFormat(_ p1: Int) -> String {
    return Localization.tr("Localizable", "onboarding_button_backup_card_format", p1)
  }
  /// Backup now
  public static let onboardingButtonBackupNow = Localization.tr("Localizable", "onboarding_button_backup_now")
  /// Scan card
  public static let onboardingButtonBackupOrigin = Localization.tr("Localizable", "onboarding_button_backup_origin")
  /// Scan ring
  ...
  /// Receive crypto
  public static let onboardingButtonReceiveCrypto = Localization.tr("Localizable", "onboarding_button_receive_crypto")
  ...
  /// We do not recommend storing the seed phrase as a screenshot due to the high risk of loss or hacking
  ...
  /// Backup card #%li
  public static func onboardingTitleBackupCardFormat(_ p1: Int) -> String {
    return Localization.tr("Localizable", "onboarding_title_backup_card_format", p1)
  }
  /// Backup ring
  ...
  public static let onboardingTopUpBody = Localization.tr("Localizable", "onboarding_top_up_body")
  /// To get started, simply top up the wallet with more than %1$@ %2$@
  public static func onboardingTopUpBodyNoAccountError(_ p1: Any, _ p2: Any) -> String {
    return Localization.tr("Localizable", "onboarding_top_up_body_no_account_error", String(describing: p1), String(describing: p2))
  }
  /// Buy crypto
  public static let onboardingTopUpButtonButCrypto = Localization.tr("Localizable", "onboarding_top_up_button_but_crypto")
  /// Show the wallet's address
  public static let onboardingTopUpButtonShowWalletAddress = Localization.tr("Localizable", "onboarding_top_up_button_show_wallet_address")
  ...
  /// Activate a wallet
  public static let onboardingTopupTitle = Localization.tr("Localizable", "onboarding_topup_title")
  ...
  public static func receiveBottomSheetWarningMessageFull(_ p1: Any) -> String {
    return Localization.tr("Localizable", "receive_bottom_sheet_warning_message_full", String(describing: p1))
  }
  ...
  /// Factory Reset will completely delete the wallet from the selected card or ring. You will not be able to restore the current wallet or use the card or ring to recover the access code.
  ...
  /// Factory Reset will completely delete the wallet from the selected card or ring and remove it from the app. You will not be able to restore the current wallet.
  ...
  /// Ring owners get 3 commission-free swaps on Changelly until 15.11!
  public static let ringPromoText = Localization.tr("Localizable", "ring_promo_text")
  /// Swap With 0%% Fees Now!
  public static let ringPromoTitle = Localization.tr("Localizable", "ring_promo_title")
  /// Do you have a bank card from another country and a residence permit or registration outside the Russian Federation?
  public static let russianBankCardWarningSubtitle = Localization.tr("Localizable", "russian_bank_card_warning_subtitle")
  /// Russian bank cards are not currently accepted
  public static let russianBankCardWarningTitle = Localization.tr("Localizable", "russian_bank_card_warning_title")
  ...
  /// Ensure the receiving wallet address is on **the %@ network** to avoid losing your tokens
  ...
  /// send to %@
  public static func sendRecipientAddressFooterHighlightedPart(_ p1: Any) -> String {
    return Localization.tr("Localizable", "send_recipient_address_footer_highlighted_part", String(describing: p1))
  }
  /// Make sure you are sending to an address on the %@ network. An error may result in the loss of funds.
  public static func sendRecipientAddressFooterV2(_ p1: Any) -> String {
    return Localization.tr("Localizable", "send_recipient_address_footer_v2", String(describing: p1))
  }
  /// Send to
  public static let sendRecipientLabel = Localization.tr("Localizable", "send_recipient_label")
  ...
  /// You’re about to stake your entire balance. We recommend leaving a small amount to cover network fees for unstaking or claiming rewards.
  ...
  /// To start staking in TON, first make an outgoing transaction of any amount — this will activate your wallet.
  ...
  /// Per Block
  public static let stakingRewardScheduleBlock = Localization.tr("Localizable", "staking_reward_schedule_block")
  /// Daily
  public static let stakingRewardScheduleDay = Localization.tr("Localizable", "staking_reward_schedule_day")
  /// Each %@
  public static func stakingRewardScheduleEach(_ p1: Any) -> String {
    return Localization.tr("Localizable", "staking_reward_schedule_each", String(describing: p1))
  }
  /// Each day
  public static let stakingRewardScheduleEachDay = Localization.tr("Localizable", "staking_reward_schedule_each_day")
  /// Each %@ days
  ...
  /// Per Epoch
  public static let stakingRewardScheduleEpoch = Localization.tr("Localizable", "staking_reward_schedule_epoch")
  /// Per Era
  public static let stakingRewardScheduleEra = Localization.tr("Localizable", "staking_reward_schedule_era")
  /// Hourly
  public static let stakingRewardScheduleHour = Localization.tr("Localizable", "staking_reward_schedule_hour")
  /// Monthly
  public static let stakingRewardScheduleMonth = Localization.tr("Localizable", "staking_reward_schedule_month")
  /// Weekly
  public static let stakingRewardScheduleWeek = Localization.tr("Localizable", "staking_reward_schedule_week")
  /// Rewards
  ...
  /// Up to 3 physical cards or rings to one wallet
  ...
  public static let swapPromoText = Localization.tr("Localizable", "swap_promo_text")
  /// New Swap Provider Available!
  public static let swapPromoTitle = Localization.tr("Localizable", "swap_promo_title")
  ...
  /// Provider slippage is up to %@.
  public static func swappingAlertSlippageDescription(_ p1: Any) -> String {
    return Localization.tr("Localizable", "swapping_alert_slippage_description", String(describing: p1))
  }
  /// Information
  ...
  public static func walletConnectAlertSignMessage(_ p1: Any) -> String {
    return Localization.tr("Localizable", "wallet_connect_alert_sign_message", String(describing: p1))
  }
  /// Dapp %1$@, requesting to\nsign BNB transaction.\n\n%2$@
  public static func walletConnectBnbSignMessage(_ p1: Any, _ p2: Any) -> String {
    return Localization.tr("Localizable", "wallet_connect_bnb_sign_message", String(describing: p1), String(describing: p2))
  }
  /// Trade order for %1$@\nPrice: %2$@\nAmount to receive: %3$@\nAmount to pay: %4$@
  public static func walletConnectBnbTradeOrderMessage(_ p1: Any, _ p2: Any, _ p3: Any, _ p4: Any) -> String {
    return Localization.tr("Localizable", "wallet_connect_bnb_trade_order_message", String(describing: p1), String(describing: p2), String(describing: p3), String(describing: p4))
  }
  /// Transaction details:\nFrom: %1$@\nTo: %2$@\nAmount: %3$@
  public static func walletConnectBnbTransactionMessage(_ p1: Any, _ p2: Any, _ p3: Any) -> String {
    return Localization.tr("Localizable", "wallet_connect_bnb_transaction_message", String(describing: p1), String(describing: p2), String(describing: p3))
  }
  /// Clipboard contain WalletConnect code. Use copied value or scan QR-code
  public static let walletConnectClipboardAlert = Localization.tr("Localizable", "wallet_connect_clipboard_alert")
  /// Request to create transaction for %1$@\n%2$@\n\nAmount: %3$@\nFee: %4$@\nTotal: %5$@\nBalance: %6$@
  public static func walletConnectCreateTxMessage(_ p1: Any, _ p2: Any, _ p3: Any, _ p4: Any, _ p5: Any, _ p6: Any) -> String {
    return Localization.tr("Localizable", "wallet_connect_create_tx_message", String(describing: p1), String(describing: p2), String(describing: p3), String(describing: p4), String(describing: p5), String(describing: p6))
  }
  /// Can't send transaction. Not enough funds.
  public static let walletConnectCreateTxNotEnoughFunds = Localization.tr("Localizable", "wallet_connect_create_tx_not_enough_funds")
  /// Failed to establish WalletConnect session. Please, try again later.
  public static let walletConnectErrorFailedToConnect = Localization.tr("Localizable", "wallet_connect_error_failed_to_connect")
  /// Not all tokens were added to your list. Please add them first and try again. Missing tokens:\n
  public static let walletConnectErrorMissingBlockchains = Localization.tr("Localizable", "wallet_connect_error_missing_blockchains")
  /// Add one of the optional networks to connect to this dApp: %@
  public static func walletConnectErrorMissingOptionalBlockchains(_ p1: Any) -> String {
    return Localization.tr("Localizable", "wallet_connect_error_missing_optional_blockchains", String(describing: p1))
  }
  /// Failed to sign message.\nPlease, try again
  public static let walletConnectErrorSingFailed = Localization.tr("Localizable", "wallet_connect_error_sing_failed")
  ...
  public static let walletConnectErrorUnsupportedBlockchains = Localization.tr("Localizable", "wallet_connect_error_unsupported_blockchains")
  /// Connection with this Dapp cannot be established due to its technical implementation.
  public static let walletConnectErrorUnsupportedDapp = Localization.tr("Localizable", "wallet_connect_error_unsupported_dapp")
  /// We've encountered unknown error. Error message: %@. If the problem persists — feel free to contact our support
  public static func walletConnectErrorWithFrameworkMessage(_ p1: Any) -> String {
    return Localization.tr("Localizable", "wallet_connect_error_with_framework_message", String(describing: p1))
  }
  /// Wrong card or ring selected in Tangem App
  public static let walletConnectErrorWrongCardSelected = Localization.tr("Localizable", "wallet_connect_error_wrong_card_selected")
  /// Failed to create transaction from Dapp data. Code: %@
  public static func walletConnectFailedToBuildTx(_ p1: Any) -> String {
    return Localization.tr("Localizable", "wallet_connect_failed_to_build_tx", String(describing: p1))
  }
  /// We've encountered unknown error. Error code: %li. If the problem persists — feel free to contact our support
  public static func walletConnectGenericErrorWithCode(_ p1: Int) -> String {
    return Localization.tr("Localizable", "wallet_connect_generic_error_with_code", p1)
  }
  /// No opened WalletConnect sessions
  public static let walletConnectNoSessionsMessage = Localization.tr("Localizable", "wallet_connect_no_sessions_message")
  /// Ooops. No Sessions.
  public static let walletConnectNoSessionsTitle = Localization.tr("Localizable", "wallet_connect_no_sessions_title")
  /// Failed to pairing WalletConnect session: %1$@
  public static func walletConnectPairingError(_ p1: Any) -> String {
    return Localization.tr("Localizable", "wallet_connect_pairing_error", String(describing: p1))
  }
  /// Paste from clipboard
  public static let walletConnectPasteFromClipboard = Localization.tr("Localizable", "wallet_connect_paste_from_clipboard")
  /// Message for %1$@:\n%2$@
  public static func walletConnectPersonalSignMessage(_ p1: Any, _ p2: Any) -> String {
    return Localization.tr("Localizable", "wallet_connect_personal_sign_message", String(describing: p1), String(describing: p2))
  }
  /// Request to start a session for\n%1$@\n\nNETWORK: %2$@\n\nURL: %3$@
  public static func walletConnectRequestSessionStart(_ p1: Any, _ p2: Any, _ p3: Any) -> String {
    return Localization.tr("Localizable", "wallet_connect_request_session_start", String(describing: p1), String(describing: p2), String(describing: p3))
  }
  /// Scan new code
  public static let walletConnectScanNewCode = Localization.tr("Localizable", "wallet_connect_scan_new_code")
  /// This card can't be used to establish WalletConnect session
  public static let walletConnectScannerErrorNotValidCard = Localization.tr("Localizable", "wallet_connect_scanner_error_not_valid_card")
  /// This network is not supported. Please select another network.
  public static let walletConnectScannerErrorUnsupportedNetwork = Localization.tr("Localizable", "wallet_connect_scanner_error_unsupported_network")
  /// Select network
  public static let walletConnectSelectNetwork = Localization.tr("Localizable", "wallet_connect_select_network")
  /// WalletConnect Sessions
  public static let walletConnectSessionsTitle = Localization.tr("Localizable", "wallet_connect_sessions_title")
  /// Connect to dApps
  ...
  public static let walletConnectToastAwaitingSessionProposal = Localization.tr("Localizable", "wallet_connect_toast_awaiting_session_proposal")
  /// From %@
  ...
  /// Buy Tangem Wallet — physical cards that securely store your crypto offline.
  ...
  /// A secure wallet is created on your phone in seconds.
  ...
  /// Do you already have Tangem Wallet?
  ...
  /// Your seed phrase to recover your wallet
  ...
  /// It seems that the card or ring activation was not completed correctly. This could be due to an issue with your device's NFC module or incorrect tapping of the card or ring to your device. Please contact our Support team for assistance.
  ...
  /// Your wallet hasn't been backed up. Carry out this procedure to protect your assets now.
  ...
  /// Tangem Wallet currently doesn’t support %s.
  public static func wcAlertUnsupportedDappsDescription(_ p1: UnsafePointer<CChar>) -> String {
    return Localization.tr("Localizable", "wc_alert_unsupported_dapps_description", p1)
  }
  /// Unsupported dApp
  ...
  /// Open Web3 app and chose WalletConnect option
  ...
  /// If you discard the backup now, then you will have to reset the devices to factory settings to start over again
  ...
  /// Something went wrong with your previous approval, so we need a new one. Choose how you’d like to proceed.
  ...
  /// Text about your money in balance
  ...
  /// Your %1$@ is now deposited in Aave and earning interest. You hold a%2$@ token, which represents your balance and grows over time. When you top up, funds go to Aave to earn interest, minus a transaction fee.
  ...
  /// Active
  public static let yieldModuleEarnSheetStatusActive = Localization.tr("Localizable", "yield_module_earn_sheet_status_active")
  /// Earn
  ...
  /// Text explaining that your savings are located in the protocol
  public static let yieldModuleExploreSheetDescription = Localization.tr("Localizable", "yield_module_explore_sheet_description")
  /// Explore Aave
  ...
  /// Your %@ is deposited in Aave 
  public static func yieldModuleExploreSheetTitle(_ p1: Any) -> String {
    return Localization.tr("Localizable", "yield_module_explore_sheet_title", String(describing: p1))
  }
  /// This is the current supply fee on %@. The live cost will be shown on the Receive Screen.
  ...
  /// All future %@ top-ups will be supplied to Aave automatically, with the transaction fee deducted.
  ...
  /// Write description here. In one, two or three lines will be awesome.
  ...
  /// Every top-up of your account will be lended to Aave automatically.
  public static let yieldModulePromoScreenAutoBalanceSubtitle = Localization.tr("Localizable", "yield_module_promo_screen_auto_balance_subtitle")
  /// Your balance works automatically
  ...
  public static let yieldModulePromoScreenTermsDisclaimer = Localization.tr("Localizable", "yield_module_promo_screen_terms_disclaimer")
  /// Earn %@% yearly
  public static func yieldModulePromoScreenTitle(_ p1: Any) -> String {
    return Localization.tr("Localizable", "yield_module_promo_screen_title", String(describing: p1))
  }
  /// Aave • Variable Interest Rate
  public static let yieldModulePromoScreenVariableRateInfo = Localization.tr("Localizable", "yield_module_promo_screen_variable_rate_info")
  /// Aave
  ...
  /// Current interest rate is always variable and automatically computed by AAVE on-chain smart-contract based on real-time supply and demand.
  ...
  /// When you top up, your funds will be automatically sent to Aave to start earning interest. A small fee equal to %@ will be deducted to cover the transaction.
  ...
  /// Your %@ will be supplied to Aave and will stay instantly available
  ...
  /// Your next deposits will be automatically supplied to Aave.
  ...
  /// Turning off will withdraw your funds from Aave, return them to %@ in your wallet, and stop earning rewards.
  ...
  /// The network fee will be deducted from the amount you withdraw.
  ...
  /// Make your money work — earn interest on your balance.
  ...
  /// Earn %1$@%% per year
  public static func yieldModuleTokenDetailsEarnNotificationTitle(_ p1: Any) -> String {
    return Localization.tr("Localizable", "yield_module_token_details_earn_notification_title", String(describing: p1))
  }
  /// Automatic
  public static let yieldModuleTransferModeAutomatic = Localization.tr("Localizable", "yield_module_transfer_mode_automatic")
  /// Deposit some %1$@ %2$@ to cover the network fee for transactions
