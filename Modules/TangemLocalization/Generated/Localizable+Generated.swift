...
public enum Localization {
  ...
  public static let hwBackupGoogleDriveDeleteConfirm = Localization.tr("Localizable", "hw_backup_google_drive_delete_confirm")
  ...
  /// Your wallet won't be backed up to Google Drive. You can set this up later in wallet settings.
  public static let hwCloudBackupCancelSetupDescription = Localization.tr("Localizable", "hw_cloud_backup_cancel_setup_description")
  /// Cancel backup setup?
  ...
  /// A password is required to encrypt your secret phrase on Google Drive.
  public static let hwCloudBackupConfirmPasswordDescription = Localization.tr("Localizable", "hw_cloud_backup_confirm_password_description")
  /// Confirm password
  ...
  /// You won't be able to restore this wallet from Google Drive. You can create a new backup anytime.
  public static let hwCloudBackupDeleteConfirmMessage = Localization.tr("Localizable", "hw_cloud_backup_delete_confirm_message")
  ...
  /// You're restoring “%1$@” from a Google Drive backup created on %2$@. Enter the encryption password to continue.
  public static func hwCloudBackupRestorePasswordDescription(_ p1: Any, _ p2: Any) -> String {
    return Localization.tr("Localizable", "hw_cloud_backup_restore_password_description", String(describing: p1), String(describing: p2))
  }
  /// Enter password
  ...
  /// A password is required to encrypt your secret phrase on Google Drive.
  public static let hwCloudBackupSetPasswordDescription = Localization.tr("Localizable", "hw_cloud_backup_set_password_description")
  /// Set password
  ...
  public static let hwImportRestoreGoogleDrive = Localization.tr("Localizable", "hw_import_restore_google_drive")
  /// Mobile Wallet
  ...
  /// Deposit via ACH or FedWire only. SWIFT transfers will be returned.
  ...
  /// Receive fiat USD via ACH/FedWire
  ...
  /// It is an indicator that shows the overall health of a cryptocurrency by combining its price performance with how actively and positively it's being talked about on social media, developed by LunarCrush.
  ...
  /// It is an indicator that compares the average price of an asset over the last 50 days with its average price over the last 200 days to show whether it's in a longer-term uptrend or downtrend.
  public static let tokenSummaryMaCrossDescription = Localization.tr("Localizable", "token_summary_ma_cross_description")
  /// It is an indicator that compares two price averages over different periods to show whether the asset's momentum is picking up or slowing down, and in which direction the trend may be shifting.
  ...
  /// It is an indicator that shows whether an asset's price has risen or fallen too quickly in the recent period, helping to spot when it might be overbought or oversold.
  public static let tokenSummaryRsiDescription = Localization.tr("Localizable", "token_summary_rsi_description")
  /// It is an indicator that shows whether people online are talking about the asset in a mostly positive or mostly negative way, based on social media and news data collected by LunarCrush.
