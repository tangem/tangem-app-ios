...
public enum Localization {
  ...
  /// Update the app to its latest version to ensure proper functionality
  ...
  /// This version of the app is no longer supported and can't be updated on this device.
  ...
  /// Your operating system is out of date. Please update it to continue using the app.
  ...
  /// Please update the app to its latest version to ensure proper functionality.
  ...
  /// By using service, you agree with provider %1$@ and %2$@
  public static func tangempayBankTransferLegal(_ p1: Any, _ p2: Any) -> String {
    return Localization.tr("Localizable", "tangempay_bank_transfer_legal", String(describing: p1), String(describing: p2))
  }
  /// Show details
  ...
  /// To pay monthly fee for plan and start use card
  ...
  /// If it will remain below zero your %1$@ cards will be closed on %2$@
