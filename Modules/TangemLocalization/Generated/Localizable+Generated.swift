...
public enum Localization {
  ...
  public static let accountArchivedRecoverErrorMessage = Localization.tr("Localizable", "account_archived_recover_error_message")
  ...
  /// These words are unrecoverable if lost. Keep them somewhere safe.
  ...
  /// Your secret recovery phrase is a fixed set of %@ random words for accessing and recovering your wallet.
  ...
  /// These words cannot be recovered if lost. Keep them safe.
  ...
  /// Save these %@ words in a secure location and never share them with anyone.
  ...
  /// Never share these words with anyone. Tangem will never ask you for them. The %@ words below are your wallet's recovery phrase. Use them to restore your wallet if you lose your device.
  ...
  /// You’re about to upgrade to our hardware wallet. This will keep your assets safe in cold storage.
  ...
  /// %s support
  public static func providerNameSupport(_ p1: UnsafePointer<CChar>) -> String {
    return Localization.tr("Localizable", "provider_name_support", p1)
  }
  /// More info
  ...
  /// To start staking, your TON account must be activated with a self-transaction of 1 TON. The funds stay in your wallet — this step only enables your account for staking.
  ...
  /// APY shows the validator’s annual percentage yield based on its performance
  ...
  public static let stakingSoloanaDetailsAutoClaimingRewardsDailyText = Localization.tr("Localizable", "staking_soloana_details_auto_claiming_rewards_daily_text")
  /// Stake locked
  ...
  /// Create account and issue a card
  ...
  /// This secret code protects your wallet and is used to log in and sign transactions.
  ...
  /// The amount received, %1$@ %2$@ was not deposited to Aave.
  ...
  /// The transaction fee must stay below 4% of your deposit. Tangem will transfer funds to Aave only once your balance is large enough to meet this condition. 
  public static func yieldModuleFeePolicySheetMinAmountNote(_ p1: Int) -> String {
    return Localization.tr("Localizable", "yield_module_fee_policy_sheet_min_amount_note", p1)
  }
  /// Minimal amount
  ...
  /// Tangem also takes a 3% service fee on the yield earned.
  public static func yieldModuleFeePolicyTangemServiceFeeTitle(_ p1: UnsafePointer<CChar>) -> String {
    return Localization.tr("Localizable", "yield_module_fee_policy_tangem_service_fee_title", p1)
  }
