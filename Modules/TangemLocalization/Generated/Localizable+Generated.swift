...
public enum Localization {
  ...
  /// Organize funds across accounts
  ...
  /// A password is required to encrypt your secret phrase on %@.
  ...
  /// I understand that if I lose or forget this password I will lose access to my crypto.
  ...
  /// This wallet was backed up earlier, but we couldn't find the backup file in your Google Drive.
  ...
  /// Enter the exact passphrase for this wallet. It's case sensitive, so a different one opens a different set of addresses.
  ...
  /// You're restoring “%1$@” from a %2$@ backup created on %3$@
  ...
  /// Almost long enough — just a couple more characters
  ...
  /// A shared account that several people own together. Money moves only when enough members sign.
  ...
  /// Maximum price change you accept between placing the order and its execution
  ...
  /// Swap across major networks and thousands of tokens 0%% fee on stablecoin-to-stablecoin swaps
  ...
  /// No cashback will be awarded for in-person/in-store purchases at EU merchants; also for withdrawals, transfers, quasi-cash, mobile phone bills, government services and certain other categories
  ...
  /// No cashback for in-person purchases at EU merchants
  ...
  /// And then swap it to payment account with 1:1 rate and zero fees
  public static let tangempayOtherNetworksSubtitle = Localization.tr("Localizable", "tangempay_other_networks_subtitle")
  /// Send USDT / USDC on any chain to your Tangem Wallet
  ...
  /// Can’t load data of the token
  public static let tokenSummaryCanNotLoadToken = Localization.tr("Localizable", "token_summary_can_not_load_token")
  /// Galaxy Score combines market performance and social media activity into a single 0 to 100 score that reflects overall asset health. Source: LunarCrush.
  ...
  /// MA Cross compares the 50-day and 200-day average prices to show whether the asset is trading above or below its long-term trend. Source: taapi.io.
  public static let tokenSummaryMaCrossDescription = Localization.tr("Localizable", "token_summary_ma_cross_description")
  /// MACD compares short-term and long-term price momentum to show whether an asset's momentum is strengthening or weakening. Source: taapi.io.
  ...
  /// Outlook for this token is not available
  ...
  /// RSI (Relative Strength Index) measures whether an asset has been bought or sold too heavily over the last 14 periods, flagging potential overbought or oversold conditions. Source: taapi.io.
  public static let tokenSummaryRsiDescription = Localization.tr("Localizable", "token_summary_rsi_description")
  /// Sentiment scores the tone of social media posts about the asset on a 1 to 5 scale, where higher means more positive discussion. Source: LunarCrush.
  ...
  /// We’re working on the ability to create more than one mobile wallet.
  ...
  /// This wallet has a backup issue. Move your funds to another wallet and reset it.
