...
public struct StoryPageView: View {
    ...
    private let page: TangemStory.Page
    private let kingfisherImageCache: ImageCache

    public init(page: TangemStory.Page, kingfisherImageCache: ImageCache) {
        self.page = page
...
#Preview {
    struct Preview: View {
        ...
        var body: some View {
            StoryView(viewModel: viewModel, pageViews: [StoryPageContainerView(content: view)])
        }
    }
