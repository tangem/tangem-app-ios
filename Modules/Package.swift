...
let package = Package(
    ...
    dependencies: [
        ...
        .package(path: "../vendor/ios_dependencies/checkouts/GRDB.swift"),
        ...
        .package(path: "../vendor/ios_dependencies/checkouts/opentelemetry-swift"),
        .package(path: "../vendor/ios_dependencies/checkouts/opentelemetry-swift-core"),
