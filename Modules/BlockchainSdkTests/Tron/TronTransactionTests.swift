...
struct TronTransactionTests {
    ...
    func trxTransfer() throws {
        ...
        #expect(transactionData == expectedTransactionData)
    }

    @Test
    func trc20TransferUSDT() throws {
        let token = Token(
            name: "Tether",
            symbol: "USDT",
        ...
        #expect(transactionDataList == expectedTransactionDataList)
    }
