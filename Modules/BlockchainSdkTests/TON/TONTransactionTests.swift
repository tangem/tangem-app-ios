...
struct TONTransactionTests {
    ...
    func correctCoinTransaction(curve: EllipticCurve) throws {
        ...
        // Validate hash size
        TransactionSizeTesterUtility().testTxSizes([buildForSign])
