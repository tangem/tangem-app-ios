...
struct PolkadotDecodingTests {
    ...
    func decodePolkadotAccountData() throws {
        // given
        let bytesToDecode = Data(hex: "50d5893bd60f0000000000000000000000000000000000000000000000000000")
        // This is bytesToDecode.reversed()
        let reversedBytes = Data(hex: "00000000000000000000000000000000000000000000000000000fd63b89d550")
