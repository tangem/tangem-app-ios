    ...
    struct IntrospectView: UIViewRepresentable {
        ...
        func updateUIView(_ uiView: UIViewType, context: Context) {
            ...
            while let responder = nextResponder {
                ...
                // if responder is a UIView, search its subview tree as well (many UIKit internals
                // put the useful views as children)
        ...
        private func searchInSubviews(_ root: UIView) -> IntrospectedType? {
            // iterative DFS with visited set and depth limit to avoid pathological recursion
