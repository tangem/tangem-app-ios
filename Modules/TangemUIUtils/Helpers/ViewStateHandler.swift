...
public extension View {
    ...
    func onFirstDidAppear(perform: @escaping () -> Void) -> some View {
        modifier(FirstDidAppearModifier(callback: perform))
    }
...
private struct FirstDidAppearModifier: ViewModifier {
    let callback: () -> Void
