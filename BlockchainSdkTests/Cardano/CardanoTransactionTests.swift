...
struct CardanoTransactionTests {
    ...
    func signTransferFromLegacy() throws {
        ...
        // then
        #expect(dataForSign.hexString.lowercased() == "03946fe122634d05e93219fde628ce55a5e0d06f23afa456864897357c5dade8")
        #expect(
            encoded.hexString.lowercased() ==
    ...
    func signTransferToken() throws {
        ...
        // then
        #expect(dataForSign.hexString.lowercased() == "3ac6b76c63e109494823fe13e6f6d52544896a5ab81ae711ce56f039d6777bd1")
        #expect(
            encoded.hexString.lowercased() ==
    ...
    func testSignStakingRegisterAndDelegate() throws {
        ...
        let encoded = output
        #expect(encoded.hexString == expectedHex)
    }
