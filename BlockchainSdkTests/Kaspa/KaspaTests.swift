...
class KaspaTests: XCTestCase {
    ...
    override func setUp() {
        ...
        unspentOutputManager = CommonUnspentOutputManager()
    ...
    func testBuildSchnorrTransaction() throws {
        unspentOutputManager.update(outputs: [
            .init(
                blockId: .random(in: 1 ... 100_000),
                hash: Data(hexString: "deb88e7dd734437c6232a636085ef917d1d13cc549fe14749765508b2782f2fb"),
                index: 0,
                amount: 10000000
            ),
            .init(
                blockId: .random(in: 1 ... 100_000),
                hash: Data(hexString: "304db39069dc409acedf544443dcd4a4f02bfad4aeb67116f8bf087822c456af"),
                index: 0,
                amount: 10000000
            ),
            .init(
                blockId: .random(in: 1 ... 100_000),
                hash: Data(hexString: "ae96e819429e9da538e84cb213f62fbc8ad32e932d7c7f1fb9bd2fedf8fd7b4a"),
                index: 0,
                amount: 500000000
            ),

        ], for: Data(hexString: "21034c88a1a83469ddf20d0c07e5c4a1e7b83734e721e60d642b94a53222c47c670dab"))
    ...
    func testP2SHTransaction() throws {
        unspentOutputManager.update(outputs: [
            .init(
                blockId: .random(in: 1 ... 100_000),
                hash: Data(hexString: "ae96e819429e9da538e84cb213f62fbc8ad32e932d7c7f1fb9bd2fedf8fd7b4a"),
    ...
    func testTransactionHash() {
        let tx1 = KaspaTransaction(
            inputs: [
                .init(
                    hash: Data(hexString: "4df1f7923708f6fa98f8d192cdb511666fc93c858d86fb7bc61bc7c13d54c9f4"),
                    index: 2,
                    amount: 0, // not used
        ...
        let tx2 = KaspaTransaction(
            inputs: [
                .init(
                    hash: Data(hexString: "03f30878b05fdfd6c47f749538f77629fd5e48c93233c36e737493caf6c67915"),
                    index: 0,
                    amount: 0, // not used
                ...
                .init(
                    hash: Data(hexString: "c69a424df624c9c235f23afc0ce20afbfd56ea042f3123e9c464ffb8b2b2f33c"),
                    index: 0,
                    amount: 0, // not used
                ...
                .init(
                    hash: Data(hexString: "2958f73001b95a36d8e51697fcb6d842b6068f49e9e46a73550e35527a40d878"),
                    index: 0,
                    amount: 0, // not used
                ...
                .init(
                    hash: Data(hexString: "705624bb67706ddc1351868ee19d7642262810cd072acbf0b08fed6050283079"),
                    index: 0,
                    amount: 0, // not used
                ...
                .init(
                    hash: Data(hexString: "7b5035caf767c7173915bfb880031e7222b1affa175343a9ca2a924e314a226d"),
                    index: 0,
                    amount: 0, // not used
