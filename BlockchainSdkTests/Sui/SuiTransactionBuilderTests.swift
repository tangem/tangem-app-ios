//
//  SuiTransactionBuilderTests.swift
//  TangemApp
//
...
final class SuiTransactionBuilderTests: XCTestCase {
    func testCoinBuildForInspect() throws {
        ...
        XCTAssert(receivedTransactionString == expectedTransactionString)
    }
    ...
    func testBuildForInspectFailsForInvalidAmount() throws {
        ...
        do {
            ...
            XCTFail("Expected to fail with: \(expectedError), received: \(error)")
        }
    }
    ...
    func testCoinBuildTransaction() throws {
        ...
        let privateKey = try XCTUnwrap(PrivateKey(data: privateKeyRaw))
        ...
        let expectedDataForSign = try XCTUnwrap(Data(base64Encoded: "q4PTuVfYzD1Qy5xch0vOEbgQfhvpFK+vrYKQK8z5vNs="))
        XCTAssertEqual(receivedDataForSign, expectedDataForSign)
        ...
        XCTAssertEqual(sendOutput.txBytes, expectedTransactionBytes)
        XCTAssertEqual(sendOutput.signature, expectedSignature)
    }
    ...
    func testTokenBuildTransaction() throws {
        ...
        let expectedDataForSign = try XCTUnwrap(Data(base64Encoded: "U+/jDrOT5RZ5c90d2v07aKvdWH14B/mAKkkporeggsE="))
        XCTAssertEqual(receivedDataForSign, expectedDataForSign)
        TransactionSizeTesterUtility().testTxSize(receivedDataForSign)
    ...
    func testCheckCoinGasBalanceIsEnoughForTokenTransaction() throws {
        ...
        XCTAssertTrue(sut.checkIfCoinGasBalanceIsNotEnoughForTokenTransaction())
        ...
        XCTAssertFalse(sut.checkIfCoinGasBalanceIsNotEnoughForTokenTransaction())
    }
}

// MARK: - Sample data and factory methods

extension SuiTransactionBuilderTests {
