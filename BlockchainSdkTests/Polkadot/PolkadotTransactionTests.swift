...
struct PolkadotTests {
    ...
    func transaction9fd062RuntimeV14(curve: EllipticCurve) throws {
        ...
        let value = try #require(Decimal(stringValue: "0.2"))
        ...
        let expectedPreImage = Data(
            hexString: "0a007120f76076bcb0efdf94c7219e116899d0163ea61cb428183d71324eb33b2bce0300943577a5030c00001a0000000500000091b171bb158e2d3848fa23a9f1c25182fb8e20313b2c1eb49219da7a70ce90c35d2143bb808626d63ad7e1cda70fa8697059d670a992e82cd440fbb95ea40351"
        )
        let expectedImage = Data(
            hexString: ""
        )
        ...
        #expect(imageWithoutSignature == expectedImageWithoutSignature)
    }
    ...
    func transactionRuntimeV14(curve: EllipticCurve) throws {
        ...
        let expectedPreImage = Data(
            hexString: "0a008eaf04151687736326c9fea17e25fc5287613693c912909cb226aa4794f26a48e5c03200000000110000000300000091b171bb158e2d3848fa23a9f1c25182fb8e20313b2c1eb49219da7a70ce90c3343a3f4258fd92f5ca6ca5abdf473d86a78b0bcd0dc09c568ca594245cc8c642"
        )
        let expectedImage = Data(
            hexString: ""
        )
        #expect(preImage == expectedPreImage)
    ...
    func transaction72dd5bRuntimeV14(curve: EllipticCurve) throws {
        ...
        let expectedPreImage = Data(
            hexString: "0a00007120f76076bcb0efdf94c7219e116899d0163ea61cb428183d71324eb33b2bce0700e40b540205010400001c0000000600000091b171bb158e2d3848fa23a9f1c25182fb8e20313b2c1eb49219da7a70ce90c37d5fa17b70251d0806f26156b1b698dfd09e040642fa092595ce0a78e9e84fcd"
        )
        let expectedImage = Data(
            hexString: ""
        )
        #expect(preImage == expectedPreImage)
    ...
    func transactionRuntimeV15(curve: EllipticCurve) throws {
        ...
        let value = try #require(Decimal(stringValue: "0.355728311783"))
        let amount = Amount(with: blockchain, value: value)
    ...
    private func removeSignature(image: Data, expectedImage: Data, signature: Data) throws -> (image: Data, expectedImage: Data) {
        let signatureRange = try #require(image.range(of: signature))
