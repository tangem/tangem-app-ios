...
final class RadiantTests {
    ...
    func script() throws {
        ...
        #expect(lockScript.data.hexString.lowercased() == legacyOutputScript.lowercased())
    }
    ...
    @Test
    func P2PKH_PrefixAddress() throws {
        ...
        #expect(adapterAddress.description == "12dNaXQtN5Asn2YFwT1cvciCrJa525fAe4")
    ...
    func signRawTransaction() throws {
        let addressAdapter = BitcoinLegacyAddressService(networkParams: BitcoinCashNetworkParams())
        let address = try addressAdapter.makeAddress(
            for: Wallet.PublicKey(seedKey: publicKey.data, derivationType: .none),
            with: .default
        )

        #expect("166w5AGDyvMkJqfDAtLbTJeoQh6FqYCfLQ" == address.value)

        let utxo = [
            UnspentOutput(
                blockId: 203208,
                txId: "4594c0fb5c5a8b4b2de2249fe704458e0e6e91e259258ca92d7c4e1067421e37",
                index: 1,
                amount: 68791375
            ),
            UnspentOutput(
                blockId: 203238,
                txId: "2ae842e688ce5e74390de3e9a4754d3f7438266ab0526ff880b9188bb4ea0c28",
                index: 0,
                amount: 100000000
            ),
            UnspentOutput(
                blockId: 203428,
                txId: "e2ea7fc29ca0dc4924f51f77918c8aff0c00fbb373a25509e928f78bf088cfcf",
                index: 0,
                amount: 10000000
            ),
            UnspentOutput(
                blockId: 203439,
                txId: "aba3aefb04a43dc026adc35972e4a20f8bdacd48074c143372f1b99cfb6bf8bc",
                index: 0,
                amount: 10000000
            ),
            UnspentOutput(
                blockId: 203500,
                txId: "ffaae960d8107cf4043dc32980c9634c9ff78fc69b2c6eb9b9c69a04a52ed179",
                index: 0,
                amount: 10000000
            ),
        ]
        ...
        #expect(hashesForSign.map { $0.hexString } == expectedHashesForSign)
        ...
        #expect(expectedSignatures.count == hashesForSign.count)
        ...
        #expect(rawTransaction.hexString.lowercased() == expectedRawTransaction)
    }
}
