...
struct ProductActivationServiceBuilder {
    ...
    func build(urlSessionConfiguration: URLSessionConfiguration, authorizationTokensHandler: VisaAuthorizationTokensHandler, logger: VisaLogger) -> ProductActivationService {
        if isMockAPIEnabled {
