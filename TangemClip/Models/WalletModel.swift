...
//    [REDACTED_USERNAME] var state: State = .idle
//    [REDACTED_USERNAME] var balanceViewModel: BalanceViewModel!
//    [REDACTED_USERNAME] var tokenItemViewModels: [TokenItemViewModel] = []
//    [REDACTED_USERNAME] var tokenViewModels: [TokenBalanceViewModel] = []
//    [REDACTED_USERNAME] var rates: [String: [String: Decimal]] = [:]
//
...
//    }
//
//    init(cardWallet: CardWallet, walletManager: WalletManager) {
