...
class PushTxViewModel: ViewModel, ObservableObject {
    ...
    init(transaction: BlockchainSdk.Transaction, blockchain: Blockchain, cardViewModel: CardViewModel, signer: TransactionSigner, ratesService: CurrencyRateService) {
