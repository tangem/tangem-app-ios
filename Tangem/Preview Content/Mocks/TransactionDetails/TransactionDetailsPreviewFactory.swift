...
enum TransactionDetailsPreviewFactory {
    ...
    static func sent() -> TransactionDetailsViewModel {
        TransactionDetailsViewModel(
            ...
            content: .send(SendTransactionDetailsViewModel(
                tokens: .init(tokenIconInfo: icon("Tether"), amountText: "−350.31 USDT", fiatText: "$350.31"),
                recipient: .init(label: "Recipient", actor: .address(short: truncatedAddress, blockiesImage: .init(image: nil)), onCopy: {}),
    ...
    static func received() -> TransactionDetailsViewModel {
        TransactionDetailsViewModel(
            ...
            content: .receive(ReceiveTransactionDetailsViewModel(
                tokens: .init(tokenIconInfo: icon("Tether"), amountText: "+350.31 USDT", fiatText: "$350.31"),
                sender: .init(label: "From address", actor: .address(short: truncatedAddress, blockiesImage: .init(image: nil)), onCopy: {})
            ))
        )
    }
