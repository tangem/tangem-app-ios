...
/// Interactive harness for the status banner preview (play the swap flow, toggle states). Lives in
/// `Preview Content` so it stays out of release builds without needing a `#if DEBUG` guard.
