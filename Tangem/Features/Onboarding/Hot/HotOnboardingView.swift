...
//                navigationBar
                ...
                viewModel.currentStep.map { step in
                    VStack {
                        navigationBar(item: step.navigation)
...
private extension HotOnboardingView {
    func navigationBar(item: HotOnboardingFlowNavigation) -> some View {
        NavigationBar(
            title: item.title,
            ...
            leftButtons: { navBarActionItem(viewModel.leadingItem) },
            rightButtons: { navBarActionItem(item.trailingItem) }
        )
    }

    @ViewBuilder
    func navBarActionItem(_ item: HotOnboardingFlowNavigation.ActionItem?) -> some View {
        switch item {
...
// struct HotOnboardingView: View {
//    [REDACTED_USERNAME] var viewModel: HotOnboardingViewModel
//
//    var body: some View {
//        ZStack {
//            ConfettiView(shouldFireConfetti: $viewModel.shouldFireConfetti)
...
//                viewModel.makeHotAccessCodeViewModel().map {
