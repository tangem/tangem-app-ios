...
///
/// The only consumer is `VerifiedAddressEntry.make(verifying:...)`, which is the sole construction
/// path for a `VerifiedAddressEntry`. Implementations must verify against the *digest* directly and
/// must not re-hash it.
