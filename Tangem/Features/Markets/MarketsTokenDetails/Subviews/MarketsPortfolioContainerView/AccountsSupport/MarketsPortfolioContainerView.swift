...
struct MarketsPortfolioContainerView: View {
    typealias ListStyle = MarketsPortfolioContainerViewModel.TypeView.ListStyle
    typealias UserWalletWithTokensData = MarketsPortfolioContainerViewModel.TypeView.UserWalletWithTokensData
    typealias UserWalletWithAccountsData = MarketsPortfolioContainerViewModel.TypeView.UserWalletWithAccountsData
    typealias AccountWithTokenItemsData = MarketsPortfolioContainerViewModel.TypeView.AccountWithTokenItemsData
    typealias AccountData = MarketsPortfolioContainerViewModel.TypeView.AccountData
