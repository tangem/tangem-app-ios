...
final class WCConnectionSheetViewModel: FloatingSheetContentViewModel, ObservableObject {
    ...
    @Injected(\.wConnectService)
    private var wcService: WCService
    ...
    func handleViewAction(_ action: ViewAction) {
        let contentSwitchAnimation: Animation = .timingCurve(0.69, 0.07, 0.27, 0.95, duration: 0.5)
