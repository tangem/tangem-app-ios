...
//    private func injectVerifiedDomainAction() {
//        guard case .dAppDetails(var details) = state else { return }
//
//        if case .content(var content) = details.dAppDescriptionSection,
//           let info = content.titleInfoConfig {
//
//            content.titleInfoConfig = .init(
...
//            )
//
//            details.dAppDescriptionSection = .content(content)
//            state = .dAppDetails(details)
//        }
//    }
}
