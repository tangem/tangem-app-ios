//
//  WalletConnectConnectionRequestDetailsViewState.swift
//  TangemApp
//
...
struct WalletConnectConnectionRequestDetailsViewState {
    ...
    static func loading(walletName: String, walletSelectionIsAvailable: Bool) -> WalletConnectConnectionRequestDetailsViewState {
...
extension WalletConnectConnectionRequestDetailsViewState {
...
extension WalletConnectConnectionRequestDetailsViewState.ConnectionRequestSection {
    struct BulletGroup {
        let label: String
...
extension WalletConnectConnectionRequestDetailsViewState.NetworksSection {
    enum SelectionMode {
