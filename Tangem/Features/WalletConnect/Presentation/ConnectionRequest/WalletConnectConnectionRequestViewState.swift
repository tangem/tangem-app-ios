...
struct WalletConnectConnectionRequestViewState {
    ...
    static func loading(walletName: String, selectionIsAvailable: Bool) -> WalletConnectConnectionRequestViewState {
        WalletConnectConnectionRequestViewState(
            ...
            walletSection: WalletSection(walletName: walletName, selectionIsAvailable: selectionIsAvailable),
