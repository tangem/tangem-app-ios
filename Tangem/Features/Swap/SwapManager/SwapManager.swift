...
protocol SwapManager: SendApproveDataBuilderInput, SendFeeUpdater, TokenFeeProvidersManagerProviding, FeeSelectorOutput {
    ...
    func update(destination: TokenItem?, address: String?, tokenHeader: ExpressInteractorTokenHeader?, accountModelAnalyticsProvider: (any AccountModelAnalyticsProviding)?)
