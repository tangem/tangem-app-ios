...
private extension AuthView {
    ...
    func walletsView(_ state: AuthViewState.WalletsState) -> some View {
    ...
    func confirmationDialogViewModel(
        for walletItem: AuthViewState.WalletItem,
        dialog: AuthViewState.ScanTroubleshootingDialog?
    ...
    func confirmationDialogViewModelForAddButton(_ state: AuthViewState.WalletsState) -> ConfirmationDialogViewModel? {
