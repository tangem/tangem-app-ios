//
//  NewActionButtonsSellViewModel.swift
//  TangemApp
//
...
final class NewActionButtonsSellViewModel: ObservableObject {
    // MARK: - Dependencies
...
extension NewActionButtonsSellViewModel: NewTokenSelectorViewModelOutput {
...
private extension NewActionButtonsSellViewModel {
    func bind() {
        sellService
