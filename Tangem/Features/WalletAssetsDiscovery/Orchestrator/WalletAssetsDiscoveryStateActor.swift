//
//  WalletAssetsDiscoveryStateActor.swift
//  Tangem
//
...
actor WalletAssetsDiscoveryStateActor {
    ...
    func startIfPossible(
        ...
        if runningTasks[userWalletId] != nil {
            throw WalletAssetsDiscoveryError.syncAlreadyInProgress
        }
...
private extension WalletAssetsDiscoveryStateActor {
