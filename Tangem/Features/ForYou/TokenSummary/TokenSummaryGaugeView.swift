...
#Preview {
    ...
    return VStack(spacing: 40) {
        TokenSummaryGaugeView(outlook: .positive, lastUpdated: date)
        TokenSummaryGaugeView(outlook: .negative, lastUpdated: date)
        TokenSummaryGaugeView(outlook: .neutral, lastUpdated: date)
        TokenSummaryGaugeView(outlook: nil, lastUpdated: nil)
    }
    .padding(24)
