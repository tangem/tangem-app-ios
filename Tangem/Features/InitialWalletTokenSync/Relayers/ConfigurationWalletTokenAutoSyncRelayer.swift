//
//  ConfigurationWalletTokenAutoSyncRelayer.swift
//  Tangem
//
...
struct ConfigurationWalletTokenAutoSyncRelayer: WalletTokenAutoSyncRelayer {
    private let configurationProvider: InitialWalletTokenSyncConfigurationProvider
    ...
    func resolveTokenStream(
        ...
        let filteredConfiguration = InitialWalletTokenSyncConfiguration(
...
private extension ConfigurationWalletTokenAutoSyncRelayer {
    func mapToTokenItems(
        configuration: InitialWalletTokenSyncConfiguration,
