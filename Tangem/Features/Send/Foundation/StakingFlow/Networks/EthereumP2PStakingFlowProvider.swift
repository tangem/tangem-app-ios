...
/// `GenericStakingFlowProvider` shape (editable amount, validator selection, target carried into the action) and
...
struct EthereumP2PStakingFlowProvider: GenericStakingFlowProvider {
