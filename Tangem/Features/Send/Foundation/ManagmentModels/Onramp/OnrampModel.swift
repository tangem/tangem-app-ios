...
class OnrampModel {
    ...
    private let receiveAddressString: String
    ...
    init(
        ...
        self.receiveAddressString = receiveAddressString
...
extension OnrampModel: OnrampRedirectingOutput {
    func redirectDataDidLoad(data: OnrampRedirectData) {
        ...
        let txData = SentOnrampTransactionData(
            ...
            destinationAddress: receiveAddressString,
            date: Date(),
