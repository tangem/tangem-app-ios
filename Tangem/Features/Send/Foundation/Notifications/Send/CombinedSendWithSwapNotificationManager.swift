//
//  CombinedSendWithSwapNotificationManager.swift
//  TangemApp
//
...
final class CombinedSendWithSwapNotificationManager {
    ...
    deinit {
        AppLogger.debug("CombinedSendWithSwapNotificationManager deinit")
    }
}

// MARK: - SendAmountNotificationService

extension CombinedSendWithSwapNotificationManager: SendAmountNotificationService {
...
// MARK: - CombinedSendWithSwapNotificationManager

extension CombinedSendWithSwapNotificationManager: NotificationManager {
