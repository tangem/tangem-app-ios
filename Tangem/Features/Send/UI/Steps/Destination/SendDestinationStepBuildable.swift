...
protocol SendDestinationStepBuildable {
    var destinationIO: SendDestinationStepBuilder2.IO { get }
    var destinationDependencies: SendDestinationStepBuilder2.Dependencies { get }

    func makeSendDestinationStep(router: any SendDestinationRoutable) -> SendDestinationStepBuilder2.ReturnValue
}

extension SendDestinationStepBuildable {
    func makeSendDestinationStep(router: any SendDestinationRoutable) -> SendDestinationStepBuilder2.ReturnValue {
        return SendDestinationStepBuilder2.make(
            io: destinationIO,
