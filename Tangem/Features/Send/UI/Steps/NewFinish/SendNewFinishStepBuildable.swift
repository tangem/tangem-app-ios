...
protocol SendNewFinishStepBuildable {
    var newFinishIO: SendNewFinishStepBuilder2.IO { get }
    var newFinishTypes: SendNewFinishStepBuilder2.Types { get }
    var newFinishDependencies: SendNewFinishStepBuilder2.Dependencies { get }
}
...
extension SendNewFinishStepBuildable {
    func makeSendFinishStep(
        ...
        SendNewFinishStepBuilder2.make(
            io: newFinishIO,
