//
//  SendNewDestinationAdditionalFieldViewModel.swift
//  TangemApp
//
...
class SendNewDestinationAdditionalFieldViewModel: ObservableObject, Identifiable {
...
extension SendNewDestinationAdditionalFieldViewModel {
    enum TitleType {
