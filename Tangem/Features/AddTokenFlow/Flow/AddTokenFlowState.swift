...
extension AddTokenFlowViewModel {
    ...
    enum ViewState: Equatable {
        ...
        case networkSelector(viewModel: NetworkSelectorViewModel, context: NavigationContext)
        ...
        static func == (
            lhs: AddTokenFlowViewModel.ViewState,
            rhs: AddTokenFlowViewModel.ViewState
        ) -> Bool {
            switch (lhs, rhs) {
