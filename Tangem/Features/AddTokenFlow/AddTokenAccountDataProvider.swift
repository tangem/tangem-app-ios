//
//  AddTokenAccountDataProvider.swift
//  TangemApp
//
...
/// Reusable data provider for AddTokenViewModel account/wallet selector
struct AddTokenAccountDataProvider: AddTokenAccountWalletSelectorDataProvider {
    let isSelectionAvailable: Bool
    let displayTitle: String
    let handleSelection: () -> Void
    let trailingContent: AddTokenViewModel.AccountWalletTrailingContent
