...
protocol AddTokenAccountWalletSelectorDataProvider {
    var displayTitle: String { get }
    var trailingContent: AddTokenViewModel.AccountWalletTrailingContent { get }
    var isSelectionAvailable: Bool { get }
    var handleSelection: () -> Void { get }
}

protocol AddTokenNetworkSelectorDataProvider {
    var displayTitle: String { get }
...
@MainActor
final class AddTokenViewModel: ObservableObject, FloatingSheetContentViewModel {
    ...
    private let accountWalletDataProvider: AddTokenAccountWalletSelectorDataProvider
    private let networkDataProvider: AddTokenNetworkSelectorDataProvider
    ...
    init(
        ...
        accountWalletDataProvider: AddTokenAccountWalletSelectorDataProvider,
        networkDataProvider: AddTokenNetworkSelectorDataProvider,
