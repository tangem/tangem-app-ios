...
func secp256k1_fe_verify(_ a: secp256k1_fe) {
    ...
    r = r && (a.n[3] <= 0x3FFFFFF * m)
    r = r && (a.n[4] <= 0x3FFFFFF * m)
    r = r && (a.n[5] <= 0x3FFFFFF * m)
    r = r && (a.n[6] <= 0x3FFFFFF * m)
    r = r && (a.n[7] <= 0x3FFFFFF * m)
    r = r && (a.n[8] <= 0x3FFFFFF * m)
    r = r && (a.n[9] <= 0x03FFFFF * m)
    r = r && (a.magnitude >= 0)
    r = r && (a.magnitude <= 32)
    if (a.normalized) {
        r = r && (a.magnitude <= 1)
...
// r *= a
// [REDACTED_USERNAME] r:secp256k1_fe
// [REDACTED_USERNAME] a:int
...
// r += a
// [REDACTED_USERNAME] r:secp256k1_fe
// [REDACTED_USERNAME] a:secp256k1_fe
...
// r = a * b
// [REDACTED_USERNAME] r: UInt32 [10]
// [REDACTED_USERNAME] a: UInt32 [10]
// [REDACTED_USERNAME] b: UInt32 [10]
...
// [REDACTED_USERNAME] r:secp256k1_fe
// [REDACTED_USERNAME] a:secp256k1_fe
// [REDACTED_USERNAME] b:secp256k1_fe
func secp256k1_fe_mul(_ r:inout secp256k1_fe, _ a:secp256k1_fe, _ b:secp256k1_fe) {
        ...
        //VERIFY_CHECK(r != b) // restrict check
    #endif
...
// r = square root a
// [REDACTED_USERNAME] [out] r:secp256k1_fe
// [REDACTED_USERNAME] [in]  a:secp256k1_fe
...
func secp256k1_fe_cmov(_ r:inout secp256k1_fe, _ a:secp256k1_fe, _ flag:Bool) {
    ...
    for i in 0..<10 {
        ...
        r.normalized = r.normalized && a.normalized
    #endif
}
...
// r = a
// [REDACTED_USERNAME] r:secp256k1_fe_storage
// [REDACTED_USERNAME] a:secp256k1_fe
...
// r = a
// [REDACTED_USERNAME] r:secp256k1_fe
// [REDACTED_USERNAME] a:secp256k1_fe_storage
