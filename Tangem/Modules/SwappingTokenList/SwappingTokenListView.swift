        ...
        NavigationView {
            PerfList {
                if #available(iOS 15.0, *) {} else {
                    ...
                    SearchBar(text: $viewModel.searchText.value, placeholder: L10n.commonSearch.text)
                ...
                GroupedSection(viewModel.userItems) {
                    ...
                    Text(L10n.swappingTokenListYourTokens.text.uppercased())
                ...
                GroupedSection(viewModel.otherItems) {
                    ...
                    Text(L10n.swappingTokenListOtherTokens.text.uppercased())
                        .style(Fonts.Bold.footnote, color: Colors.Text.tertiary)
                }
                .separatorPadding(68)
            ...
            .navigationBarTitle(Text(L10n.swappingTokenListYourTitle.text), displayMode: .inline)
