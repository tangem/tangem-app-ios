...
struct SendAmountView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        SendAmountView(namespace: namespace, viewModel: SendAmountViewModel(input: SendAmountViewModelInputMock(), fiatCryptoAdapterOutput: SendFiatCryptoAdapterOutputMock(), walletInfo: walletInfo))
    }
}
