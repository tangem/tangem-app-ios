...
#Preview("Different cases") {
    SendSuggestedDestinationView(
        viewModel: SendSuggestedDestinationViewModel(
            ...
            recentTransactions: [
                .init(address: "0x391316d97a07027a0702c8A002c8A0C25d8470", additionalField: nil, isOutgoing: false, date: .init(), amount: 20.09, amountFormatted: "20,09 USDT", dateFormatted: "24.05.2004 at 14:46"),
                .init(address: "0x391316d97a07027a", additionalField: "123142", isOutgoing: true, date: .init(), amount: 1, amountFormatted: "1 USDT", dateFormatted: "today at 14:46"),
                .init(address: "0x391316d97a07027a0702c8A002c8A0C25d84700x391316d97a07027a0702c8A002c8A0C25d8470", additionalField: nil, isOutgoing: false, date: .init(), amount: 1_000_000_000_000_000_000_000_000_000_000.123012310, amountFormatted: "1 000 000 000 000 000 000 000 000 000 000.123012310 USDT", dateFormatted: "today at 14:46"),
            ],
            tapAction: { _ in }
        )
    )
    ...
    GroupedScrollView {
        SendSuggestedDestinationView(
            viewModel: SendSuggestedDestinationViewModel(
                ...
                recentTransactions: [
                    .init(address: "0x391316d97a07027a0702c8A002c8A0C25d84700x391316d97a07027a0702c8A002c8A0C25d8470", additionalField: nil, isOutgoing: true, date: .init(), amount: 1_000_000_000_000_000_000_000_000_000_000.123012310, amountFormatted: "1 000 000 000 000 000 000 000 000 000 000.123012310 USDT", dateFormatted: "today at 14:46"),
                    .init(address: "0x391316d97a07027a0702c8A002c8A0C25d8470", additionalField: nil, isOutgoing: false, date: .init(), amount: 20.09, amountFormatted: "20,09 USDT", dateFormatted: "24.05.2004 at 14:46"),
                ],
                tapAction: { _ in }
            )
