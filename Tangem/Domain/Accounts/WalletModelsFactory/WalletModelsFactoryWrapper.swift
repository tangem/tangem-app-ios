//
//  WalletModelsFactoryWrapper.swift
//  Tangem
//
...
final class WalletModelsFactoryWrapper {
    ...
    private func enrichWalletModels(_ walletModels: [any WalletModel]) {
        guard let cryptoAccount else {
            preconditionFailure("Crypto account is not set for WalletModelsFactoryWrapper")
        }
...
extension WalletModelsFactoryWrapper: WalletModelsFactory {
...
// MARK: - WalletModelsFactoryInput protocol conformance

extension WalletModelsFactoryWrapper: WalletModelsFactoryInput {
...
private extension WalletModelsFactoryWrapper {
