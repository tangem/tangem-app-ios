...
extension WarningEvent {
    ...
    private var priority: WarningPriority {
        ...
        case .failedToVerifyCard, .testnetCard, .demoCard, .devCard, .lowSignatures, .legacyDerivation, .systemDeprecationPermanent:
            return .critical
        case .systemDeprecationTemporary, .failedSupportedBlockchainByWallets, .failedSupportedSingleCurrencyWallet:
            return .warning
    ...
    private var type: WarningType {
        ...
        case .failedToVerifyCard, .testnetCard, .demoCard, .oldDeviceOldCard, .oldCard, .devCard, .lowSignatures, .legacyDerivation, .systemDeprecationPermanent:
            return .permanent
        case .missingDerivation, .walletLocked, .missingBackup, .failedSupportedBlockchainByWallets,
             .failedSupportedSingleCurrencyWallet: // New cases won't be displayed in new design
            return .temporary
        }
    }
    ...
    private var appWarningTitle: String {
        ...
        case .testnetCard, .demoCard, .oldDeviceOldCard, .oldCard, .devCard, .lowSignatures, .numberOfSignedHashesIncorrect, .legacyDerivation:
            return defaultTitle
        case .missingDerivation, .walletLocked, .missingBackup, .failedSupportedBlockchainByWallets, .failedSupportedSingleCurrencyWallet: // New cases won't be displayed in new design
            return defaultTitle
        }
    }
}
