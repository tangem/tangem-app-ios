...
class TotalBalanceAnalyticsService {
    ...
    func firstLoadBalanceForCard(tokenItemViewModels: [TokenItemViewModel], balance: Decimal) {
    ...
    func toppedUpCheck(tokenItemViewModels: [TokenItemViewModel], balance: Decimal) {
