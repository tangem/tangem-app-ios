...
class DeprecationService {
    private let firstSupportedSystemVersion = "14.7"
    private let systemVersion = UIDevice.current.systemVersion

    private let daysBetweenWarnings = 7
    private let permanentSystemDeprecationWarningDate = DateComponents(calendar: Calendar(identifier: .gregorian), year: 2023, month: 1, day: 15).date!
