...
struct TokensView_Previews: PreviewProvider {
    static var previews: some View {
        ZStack {
            Color.tangemBgGray
            TokensView(items: [
                TokenItemViewModel(state: .idle, displayState: .busy,
                ...
                TokenItemViewModel(state: .idle, displayState: .busy,
                                   ...
                                   fiatValue: 0,
                                   isCustom: true),
                TokenItemViewModel(state: .loading, displayState: .busy,
                                   hasTransactionInProgress: false,
                                   ...
                                   fiatValue: 0,
                                   isCustom: false),
                TokenItemViewModel(state: .failed(error: "The internet connection appears to be offline. Very very very long error description. Very very very long error description. Very very very long error description. Very very very long error description. Very very very long error description. Very very very long error description"), displayState: .busy, hasTransactionInProgress: false,
                                   name: "Ethereum smart contract token",
                                   fiatBalance: " ",
                                   balance: " ",
                                   rate: "1.5 USD",
