//
//  CommonUserTokensManagerContainsTests.swift
//  TangemTests
//
...
@Suite("Test for `CommonUserTokensManager.contains(_:derivationInsensitive:)` logic")
struct CommonUserTokensManagerContainsTests {
    ...
    ) throws -> CommonUserTokensManager {
