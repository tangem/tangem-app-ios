//
//  GenericStakingProfileTests.swift
//  TangemTests
//
...
@Suite("GenericStakingProfile")
struct GenericStakingProfileTests {
    // MARK: - stepPlan

    @Test("Editable stake: amount editable, validator selectable, summary fully editable")
    func stakeEditable() {
        let plan = GenericStakingProfile.stepPlan(for: stake(), isStakeAmountEditable: true, isPartialUnstakeAllowed: false)
    ...
    func stakeFixed() {
        let plan = GenericStakingProfile.stepPlan(for: stake(amount: 100), isStakeAmountEditable: false, isPartialUnstakeAllowed: false)
    ...
    func restake() {
        ...
        let plan = GenericStakingProfile.stepPlan(for: action, isStakeAmountEditable: true, isPartialUnstakeAllowed: false)
    ...
    func unstakePartialAllowed() {
        let plan = GenericStakingProfile.stepPlan(for: unstake(amount: 7), isStakeAmountEditable: true, isPartialUnstakeAllowed: true)
    ...
    func unstakePartialDisallowed() {
        let plan = GenericStakingProfile.stepPlan(for: unstake(amount: 7), isStakeAmountEditable: true, isPartialUnstakeAllowed: false)
    ...
    func singleAction() {
        ...
        let plan = GenericStakingProfile.stepPlan(for: action, isStakeAmountEditable: true, isPartialUnstakeAllowed: true)
    ...
    func makeActionEditable() {
        let plan = GenericStakingProfile.stepPlan(for: stake(), isStakeAmountEditable: true, isPartialUnstakeAllowed: false)
        let action = GenericStakingProfile.makeAction(stepPlan: plan, action: stake(), amount: 5, target: nil)
    ...
    func makeActionFixed() {
        ...
        let plan = GenericStakingProfile.stepPlan(for: original, isStakeAmountEditable: true, isPartialUnstakeAllowed: true)
        let action = GenericStakingProfile.makeAction(stepPlan: plan, action: original, amount: 999, target: nil)
    ...
    func makeActionPresetEditable() {
        ...
        #expect(GenericStakingProfile.makeAction(stepPlan: plan, action: original, amount: 4, target: nil).amount == 4)
        #expect(GenericStakingProfile.makeAction(stepPlan: plan, action: original, amount: nil, target: nil).amount == 7)
    }
