...
class IncomingActionsTests: XCTestCase {
    ...
    func testDeeplinks() {
        ...
        XCTAssertNotNil(parser.parseDeeplink(URL(string: "tangem://wc?uri=wc:12e2e015-0ae0-4bac-9d2b-b67244388eb9@1?bridge=https%3A%2F%2Fw.bridge.walletconnect.org&key=aede7f2aedde949ef1812ac624362a53737dd57acdce2d0e44b247a109d87d98")!))
        ...
        XCTAssertNotNil(parser.parseDeeplink(URL(string: "https://app.tangem.com/wc?uri=wc:5ae26da3-e0e9-4dd7-bc35-380d6f77afdb@1?bridge=https%3A%2F%2Fo.bridge.walletconnect.org&key=33156d17ff3aa7384f803501691e7a2a3205edbc03f2dfa22d4ee3e4db036348")!))
    }
